...
class FacultyController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.program.faculties.index')
    ...
    {
        return view('backend.program.faculties.create');
    }
    ...
    public function store(CreateFacultyRequest $request)
    {
        ...
        return redirect(route('admin.program.faculty.index'));
    }
    ...
    public function show($id)
    {
        ...
        if (empty($faculty)) {
            ...
            return redirect(route('backend.program.faculties.index'));
        }

        return view('backend.program.faculties.show')->with('faculty', $faculty);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.program.faculties.edit')->with('faculty', $faculty);
    }
